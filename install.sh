...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='celix.conf'
CONFIGFOLDER='/root/.celix/'
COIN_DAEMON='/usr/local/bin/celixd'
COIN_CLI='/usr/local/bin/celix-cli'
COIN_TGZ='https://github.com/GregMcwolf/celixinstall/files/2407115/celix.zip'
COIN_ZIP='https://github.com/GregMcwolf/celixinstall/files/2407115/celix.zip'
COIN_NAME='celix'
COIN_PORT=9777
RPC_PORT=7574
...
daemon=1
port=$COIN_PORT
addnode=45.76.81.171:9777
addnode=8.12.16.153:9777
addnode=45.76.141.200:9777
addnode=149.28.183.70:9777
EOF
}
